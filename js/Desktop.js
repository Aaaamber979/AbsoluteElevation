...
const userEmailData = {
    ...
    'special': {
        inbox: [{
            id: 11,
            from: '杨敏',
            fromEmail: 'yangmin_123@jcschool.edu',
            to: 'regret_0928@privatemail.com',
            subject: '爸爸，我下周去江州看你',
            date: '2030-07-01 09:12',
            preview: '我已经毕业了，我想和你一起......',
            hasAttachment: false,
            content: `
                        <p>我已经毕业了，我想和你一起在江州工作。</p>
                        <p>这么多年来，我们一直书信联系，你也没有回过家，现在我们可以在江州团聚了。</p>
                        <p>我等不了了。我下周就去您工作的地方找您。</p>
                        `,
            canReply: false
        }, {
            id: 12,
            from: '邮政',
            fromEmail: 'postmaster@post.cn',
            to: 'regret_0928@privatemail.com',
            subject: '邮政汇款业务成功通知',
            date: '2026-05-02 09:12',
            preview: '尊敬的客户：',
            hasAttachment: false,
            content: `
                        <p>尊敬的客户：</p>
                        <p>您于2026年5月1日办理的邮政汇款业务已成功。</p>
                        <p>收款人：杨敏</p>
                        <p>收款地址：XX省XX市青云镇XX村</p>
                        <p>汇款金额：2000.00 元</p>
                        <p>业务单号：20260502-XXXX-XXXX</p>
                        <p>感谢您的使用。</p>
                        `,
            canReply: false
        }, {
            ...
            content: `
                        <p>尊敬的客户：</p>
                        <p>您于2026年4月1日办理的邮政汇款业务已成功。</p>
                        <p>收款人：杨敏</p>
                        <p>收款地址：XX省XX市青云镇XX村</p>
                        <p>汇款金额：2000.00 元</p>
                        <p>业务单号：20260402-XXXX-XXXX</p>
                        <p>感谢您的使用。</p>
                        `,
            canReply: false
        }, {
            ...
            to: 'regret_0928@privatemail.com',
            subject: '邮政汇款业务成功通知',
            date: '2026-03-02 09:12',
            preview: '尊敬的客户：',
            hasAttachment: false,
            content: `
                        <p>尊敬的客户：</p>
                        <p>您于2026年3月1日办理的邮政汇款业务已成功。</p>
                        <p>收款人：杨敏</p>
                        <p>收款地址：XX省XX市青云镇XX村</p>
                        <p>汇款金额：2000.00 元</p>
                        <p>业务单号：20260302-XXXX-XXXX</p>
                        <p>感谢您的使用。</p>
                        `,
            canReply: false
        }, {
        ...
        sent: [{
            ...
            to: 'yangmin_123@jcschool.edu',
            subject: 'Re: 爸爸，我下周去江州看你',
            date: '2030-07-01 14:12',
            preview: '敏敏：爸爸在江州的工程到了......',
            hasAttachment: false,
            content: `
                <p>敏敏：</p>
                <p>爸爸在江州的工程到了关键阶段，走不开。江州这边环境复杂，你刚毕业，老老实实在老家找个安稳工作。</p>
                <p>听爸爸的话，千万别来江州找我。等忙完这阵子自然会回去。钱已经打到你卡上了，别再发邮件了，我很忙。</p>
            `,
            canReply: false
        }]
    }
...
function restoreTriggeredEmails() {
    ...
    // 恢复律师函
    if (triggeredEmailIds.includes(201)) {
        // 检查是否已经存在
        const existingEmail = emailData.inbox.find(e => e.id === 201);
...
const SU_EMAIL_TEMPLATE = {
    id: 201,
    from: '苏柏年 - 副总裁',
    fromEmail: 'bonian.su@yuding-holdings.cn',
    to: 'hejia@jz-structure.cn',
    subject: '关于终止海伯利安委托及追究法律责任的正式函件',
    date: getCurrentTime(),
    preview: '江州精算工作室负责人：本函代表誉',
    hasAttachment: false,
    content: `
                <p>江州精算工作室负责人：</p>
                <p>本函代表誉鼎城市发展控股集团有限公司（以下简称"我司"），就贵司在履行《海伯利安大厦定向爆破结构安全评估委托合同》过程中的严重违约行为，正式通知如下：</p>
                <p><b>一、终止委托</b></p>
                <p>鉴于贵司项目执行人（禾佳）未经授权擅自使用我司员工的OA账号，越权访问后勤管理系统历史数据。该行为已严重违反双方签署的《保密协议》第4条及《反商业窃密法》相关规定。</p>
                <p>我司决定<b>立即终止</b>与贵司的所有合作关系；</p>
                <p>冻结尚未支付的评估尾款</p>
                <p><b>启用备用方案</b>，委托其他机构完成后续评估工作。</p>
                <p>我司理解，贵司作为小型评估机构，可能受到外部不明势力的诱导或施压，做出了上述不理智行为。</p>
                <p>但请注意：海伯利安大厦的定向爆破工程已获批准，任何阻挠行为都将被视为妨碍重大工程建设。</p>
                <p>贵司若继续散布不实信息或试图干扰工程进展，我司将采取一切法律手段，追究到底。</p>
                <p>我司希望贵司能够认清形势，立即停止一切不当行为，配合我司完成后续交接工作。否则，后果自负。</p>
                <p>苏柏年</p>
                <p>副总裁</p>
                <p>誉鼎城市发展控股集团有限公司</p>
            `,
...
const REGRET_REPLY_EMAIL_TEMPLATE = {
    ...
    subject: '匿名',
    date: getCurrentTime(),
    preview: '对不起，我对不起老杨，对不起敏敏。。。',
    hasAttachment: false,
    content: `
                <p>对不起，我对不起老杨，对不起敏敏。</p>
                <p>当时我真的是急需用钱。但是我很快就缓过味了，这是我兄弟的人血馒头，我实在是不敢花，我全都寄给敏敏了。</p>
                <p>当年的事情，我真的后悔一辈子，你也给我一个解脱吧。</p>
                <p>出事第二天我存了老杨留下来的东西，都扫描了放在我的网盘里。<a href="wangpan.html">【网盘】</a>
                <p>管理员密码是保单号后六位。</p>
            `,
    canReply: false
};
...
function loginWithOtherAccount() {
    ...
    if (account === specialAccount.account && password === specialAccount.password) {
        currentUser = { username: 'regret_0928', email: specialAccount.account };
        localStorage.setItem('currentUser', JSON.stringify(currentUser));
...
function restoreSentEmails() {
    ...
    if (currentUser.username === 'regret_0928' && savedData['special']) {
...
stageKey = localStorage.getItem('stageKey') // 看当前阶段
if (stageKey === null) {
    // 开屏黑屏淡出效果
...
} else if (stageKey === 'isStage2') { // 阶段二，需要新收到邮件
    bootScreen.style.display = 'none'; // 不展示黑幕
    quickLogin()
    const suEmail = JSON.parse(JSON.stringify(SU_EMAIL_TEMPLATE));
    emailData.inbox.unshift(suEmail);
    updateEmailUI();
    // 获取已触发的邮件ID列表
    const triggeredEmailIds = JSON.parse(localStorage.getItem('triggeredEmailIds') || '[]');
    if (!triggeredEmailIds.includes(201)) { // 未触发过
        // 深拷贝模板,避免引用污染
        triggeredEmailIds.push(201);
        localStorage.setItem('triggeredEmailIds', JSON.stringify(triggeredEmailIds));
        showMysteryEmailNotification(); // 新邮件提醒
    }
} else {
    bootScreen.style.display = 'none'; // 不展示黑幕
}
    ...
    'lisi': [
        {
            ...
            messages: [
                { from: 'lisi', imagePlaceholder: '../assets/mountain.png', time: '16:45', isImage: true },
                            ...
                            <div class="wechat-message ${isSelf ? 'self' : ''}">
                                ...
                                <div class="wechat-msg-content">
                                    <div class="wechat-msg-bubble" style="padding: 5px; background: #f0f0f0;">
                                        <img src="${msg.imagePlaceholder}" alt="朋友圈图片" style="top: 0; left: 0; width: 200px; height: 200px; object-fit: cover; cursor: pointer;" onclick="window.open('${msg.imagePlaceholder}', '_blank')">
                                    </div>
