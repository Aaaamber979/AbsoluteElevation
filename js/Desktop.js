        ...
        dropZone.addEventListener('drop', (e) => {
            ...
            console.log('拖拽的数据:', filename); // 调试信息
            ...
            momentsData.forEach(moment => {
                ...
                if (moment.images && moment.images.length > 0) {
                    ...
                    moment.images.forEach(img => {
                        imagesHtml += `
                            <div style="width: 100%; padding-bottom: 100%; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 5px; position: relative;">
